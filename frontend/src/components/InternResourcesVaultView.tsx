...
import { Student, InternResource, isDemoStudent } from "../types";
import {
  FolderGit2,
  FileText,
  Presentation,
...
export const DEFAULT_SAMPLE_RESOURCES = (studentId: string, batchId?: string): InternResource[] => [
  {
    id: `res-${studentId}-1`,
    studentId,
    batchId: batchId || "batch_1788462977274",
...
export const InternResourcesVaultView: React.FC<InternResourcesVaultViewProps> = ({
  ...
  const [resources, setResources] = useState<InternResource[]>(() => {
    ...
    return isDemoStudent(currentStudent)
      ? DEFAULT_SAMPLE_RESOURCES(currentStudent.id, currentStudent.batchId)
      : [];
  });
