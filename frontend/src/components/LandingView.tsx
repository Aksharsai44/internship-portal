...
const LandingView: React.FC<LandingViewProps> = ({ onLoginClick }) => {
  ...
  const stats = [
    { value: "3 - 6 Mo", label: "Structured Internships" },
    { value: "500+", label: "Interns Mentored" },
    { value: "50+", label: "Hiring Clients" },
  ...
  const features = [
    {
      icon: Monitor,
      title: "Full-Stack Development IDE",
      description: "Hands-on coding, compiler test cases, and real-world project tasks in browser supporting Python, JavaScript, TypeScript, and modern frameworks.",
      color: "sky",
    },
    {
      icon: Brain,
      title: "Agentic AI & Engineering",
      description: "Structured curriculum covering LLM pipelines, autonomous agents, prompt architecture, and enterprise cloud technologies.",
      color: "violet",
    },
    {
      icon: Trophy,
      title: "Live Intern Leaderboard",
      description: "Transparent ranking based on coding scores, assignment accuracy, and active milestones to spotlight top technical talent.",
      color: "amber",
    },
    {
      icon: Building2,
      title: "Client Portal & Interviews",
      description: "Dedicated client mode for corporate partners to evaluate cohort performance, explore skill profiles, and schedule interviews.",
      color: "emerald",
    },
  ];

  const howItWorks = [
    { step: "01", title: "Admin Sets Up Cohort", description: "Admin creates 3-month or 6-month internship cohorts, designates technology tracks, and assigns mentors." },
    { step: "02", title: "Interns Build & Excel", description: "Interns complete technical challenges, assignments, and guided AI modules while accumulating leaderboard points." },
    { step: "03", title: "Clients Review Leaderboard", description: "Hiring partners log in to review assigned cohort rankings, examine skill profiles, and assess verified scores." },
    { step: "04", title: "Direct Interview Scheduling", description: "Clients request and schedule interviews with promising interns directly through the integrated portal." },
  ];
      ...
      <section className="relative pt-10 pb-16 md:pt-16 md:pb-24 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-8 relative z-10">
          <div className="text-center max-w-3xl mx-auto">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/90 backdrop-blur-md border border-teal-200 text-teal-700 text-[11px] font-black uppercase tracking-wider mb-5 shadow-sm shadow-teal-500/10">
              <Sparkles className="w-3.5 h-3.5 text-teal-500 animate-pulse" />
              Internship Management & Talent Pipeline Platform
            </div>
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black text-slate-900 tracking-tight leading-[1.12] mb-5">
              ...
              <span className="relative inline-block">
                ...
                <svg className="absolute -bottom-1.5 left-0 w-full" viewBox="0 0 300 12" fill="none">
                  ...
                  <defs><linearGradient id="grad" x1="0" y1="0" x2="300" y2="0"><stop offset="0%" stopColor="#0d9488" /><stop offset="100%" stopColor="#06b6d4" /></linearGradient></defs>
                </svg>
              </span>
            </h1>

            <p className="text-sm sm:text-base md:text-lg text-slate-600 font-medium max-w-2xl mx-auto leading-relaxed mb-8">
              The unified platform for managing 3 to 6-month technical internship cohorts. Track skill milestones, maintain live performance leaderboards, and allow hiring clients to discover verified talent and schedule interviews.
            </p>
