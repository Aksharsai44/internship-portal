...
export const AdminDashboardView: React.FC<AdminDashboardViewProps> = ({
  ...
  const [questionTab, setQuestionTab] = useState<"speed" | "correct" | "wrong" | "unattempted">("speed");
    ...
    onCreateInstantPoll({
      ...
      correctAnswer:
        pollType === "mcq" || pollType === "true_false"
          ? pollCorrect
          : pollSampleReference.trim() || undefined,
      type: pollType,
    ...
    <div className="space-y-6 pb-12">
      ...
      {settings && (
        <LiveSessionBanner
          ...
          onDeleteScheduledMeeting={onDeleteScheduledMeeting}
                    ...
                    <div className="px-6 pt-5 pb-4 flex items-start justify-between gap-3">
                      ...
                      <div className="flex items-center gap-2 flex-shrink-0">
                        <div className="text-right">
                          <div className="text-xs font-black text-slate-800">{totalResponses}/{totalBatchMembers}</div>
                          <div className="text-[10px] text-slate-400 font-bold">submitted</div>
                        </div>
                        <button
                          onClick={() => {
                          ...
                          title="Open Speed Leaderboard and detailed student responses"
                        >
                      ...
                      <div className="px-6 pb-5 pt-3 border-t border-slate-100/80 bg-slate-50/30">
                        <div className="flex items-center justify-between text-[10px] font-black text-slate-400 uppercase tracking-wider mb-3">
                          <span className="flex items-center gap-1.5 text-amber-600">
                            <Flame className="w-3.5 h-3.5" /> Fastest Responders
                          </span>
                          <span>Speed</span>
                        </div>
                          ...
                          {fastestResponders.map((resp, rIdx) => (
                            ...
                            >
                              <span className={`w-6 h-6 rounded-lg flex items-center justify-center text-[10px] font-black ${
                                ...
                                rIdx === 1 ? 'bg-slate-200 text-slate-600' :
                                rIdx === 2 ? 'bg-orange-100 text-orange-700' :
                  ...
                  .map((resp, rank) => (
                    ...
                    >
                      ...
                      <div className="text-right flex flex-col items-end">
                        ...
                        <span className="text-[9px] font-bold uppercase tracking-wider text-emerald-600 bg-emerald-50 px-1.5 py-0.5 rounded mt-1">
                          +100 pts
                        </span>
                      </div>
                    </div>
              ...
              <div className="lg:col-span-7 space-y-4">
                ...
                {pollType === "mcq" || pollType === "poll" ? (
                  ...
                  <div className="space-y-1.5">
                    ...
                    <textarea
                      rows={4}
                      value={pollSampleReference}
                      onChange={(e) => setPollSampleReference(e.target.value)}
                  ...
                  <div className="space-y-1.5 p-3 rounded-2xl bg-slate-50/70 border border-slate-200/80">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-[10px] text-slate-400 font-bold font-mono">
                        {pollTimeLimit === 0 ? "No Timer" : `${pollTimeLimit}s`}
                      </span>
                    </div>
                    <div className="relative">
                      <input
                        ...
                        max={600}
                        value={pollTimeLimit}
                        onChange={(e) => setPollTimeLimit(Math.max(0, parseInt(e.target.value) || 0))}
