...
export const ProjectSubmissionsRosterModal: React.FC<ProjectSubmissionsRosterModalProps> = ({
  ...
  const cohortStudents = useMemo(() => {
    ...
    // If pool is small, supplement with realistic mock cohort members
    if (pool.length < 5) {
      const mockPool: Student[] = [
        {
          id: "student_01",
          name: "Alex Rivera",
          email: "alex.rivera@mind2i.edu",
          mobile: "+1 555-0192",
          batchId: project.batchId || "batch-01",
          batchName: project.batchName || "AI & Product Design",
          avatar: "https://api.dicebear.com/7.x/bottts/svg?seed=AlexRivera",
          college: "Stanford University",
          enrolledAt: "2026-08-01",
          status: "active",
          scores: { quizScore: 92, codingScore: 95, liveQAScore: 90, assignmentScore: 94, overallAccuracy: 93.5 },
          totalPoints: 1250, activeStreakDays: 14, fastestResponseMs: 1200, attendedSessions: 18, totalSessions: 20, skills: ["React", "TypeScript", "Tailwind"]
        },
        {
          id: "stu_02",
          name: "Priya Sharma",
          email: "priya.sharma@mind2i.edu",
          mobile: "+1 555-0193",
          batchId: project.batchId || "batch-01",
          batchName: project.batchName || "AI & Product Design",
          ...
          enrolledAt: "2026-08-01",
          status: "active",
          scores: { quizScore: 88, codingScore: 91, liveQAScore: 85, assignmentScore: 89, overallAccuracy: 88.2 },
          totalPoints: 1120, activeStreakDays: 11, fastestResponseMs: 1450, attendedSessions: 17, totalSessions: 20, skills: ["React", "Design Systems"]
        },
        {
          id: "stu_03",
          name: "Marcus Chen",
          email: "marcus.chen@mind2i.edu",
          mobile: "+1 555-0194",
          batchId: project.batchId || "batch-01",
          batchName: project.batchName || "AI & Product Design",
          ...
          enrolledAt: "2026-08-01",
          status: "active",
          scores: { quizScore: 85, codingScore: 89, liveQAScore: 92, assignmentScore: 87, overallAccuracy: 87.5 },
          totalPoints: 1080, activeStreakDays: 9, fastestResponseMs: 1100, attendedSessions: 16, totalSessions: 20, skills: ["Next.js", "Docker"]
        },
        {
          id: "stu_04",
          name: "Sophia Rodriguez",
          email: "sophia.rodriguez@mind2i.edu",
          mobile: "+1 555-0195",
          batchId: project.batchId || "batch-01",
          batchName: project.batchName || "AI & Product Design",
          ...
          enrolledAt: "2026-08-01",
          status: "active",
          scores: { quizScore: 94, codingScore: 96, liveQAScore: 94, assignmentScore: 95, overallAccuracy: 95.0 },
          totalPoints: 1340, activeStreakDays: 18, fastestResponseMs: 950, attendedSessions: 19, totalSessions: 20, skills: ["PyTorch", "FastAPI"]
        },
        {
          id: "stu_05",
          name: "Liam Vance",
          email: "liam.vance@mind2i.edu",
          mobile: "+1 555-0196",
          batchId: project.batchId || "batch-01",
          batchName: project.batchName || "AI & Product Design",
          avatar: "https://api.dicebear.com/7.x/bottts/svg?seed=LiamVance",
          college: "Georgia Tech",
          enrolledAt: "2026-08-01",
          status: "active",
          scores: { quizScore: 80, codingScore: 82, liveQAScore: 78, assignmentScore: 80, overallAccuracy: 80.0 },
          totalPoints: 920, activeStreakDays: 5, fastestResponseMs: 1800, attendedSessions: 14, totalSessions: 20, skills: ["Node.js", "Express"]
        },
        {
          id: "stu_06",
          name: "Elena Rostov",
          email: "elena.rostov@mind2i.edu",
          mobile: "+1 555-0197",
          batchId: project.batchId || "batch-01",
          batchName: project.batchName || "AI & Product Design",
          avatar: "https://api.dicebear.com/7.x/bottts/svg?seed=ElenaRostov",
          college: "Univ of Michigan",
          enrolledAt: "2026-08-01",
          status: "active",
          scores: { quizScore: 89, codingScore: 90, liveQAScore: 86, assignmentScore: 88, overallAccuracy: 88.5 },
          totalPoints: 1100, activeStreakDays: 12, fastestResponseMs: 1300, attendedSessions: 17, totalSessions: 20, skills: ["UI/UX", "Figma"]
        }
      ];
      const existingIds = new Set(pool.map(s => s.id));
      const combined = [...pool, ...mockPool.filter(m => !existingIds.has(m.id))];
      return combined;
    }
    return pool;
